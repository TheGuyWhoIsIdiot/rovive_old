...
$gameclass = new Game;
$game = $gameclass::getGame(intval($_GET['id']));
...
if (!isset($_SESSION["user"])) {
    ...
    $canPlay = $game["status"] == "public";
    $canManage = $game["creator_id"] == $_SESSION["user"]["id"] || $_SESSION["user"]["admin"] >= 2;
    $canEdit = $game["creator_id"] == $_SESSION["user"]["id"] || $_SESSION["user"]["admin"] >= 2;
    $canCopy = $game["creator_id"] == $_SESSION["user"]["id"] || $_SESSION["user"]["admin"] >= 2;
        ...
        <div class="col-xs-12 section-content game-main-content">
            ...
            <div class="game-calls-to-action">
                        ...
                        <div class="rbx-popover-content" data-toggle="game-context-menu">
                            <ul class="dropdown-menu" role="menu">
                                <?php if ($canEdit) { ?>
                                    ...
                                    <?php if ($canManage) { ?>
                                        <li id="configure">
                                            <a href="https://www.rovive.pro/develop/configure?id=<?= $game["id"] ?>/update">Configure this
                                                Game</a>
                                        </li>
                                        <li>
                                            <div id="toggle-profile" data-place-id="<?= $game["id"] ?>" class="rbx-context-menu-toggle-profile"><a><?php if ($gameOnProfile) { ?>Remove from Profile<?php } else { ?>Add to Profile<?php } ?></a></div>
                                        </li>
                                        <li>
                ...
                <div class="game-title-container">
                    ...
                    <div class="game-creator"><span class="text-label">By</span> <a class="text-name" href="https://www.rovive.pro/users/<?= $creator_id ?>/profile"><?= htmlspecialchars($creator["username"]) ?></a>
                    </div>
                </div>
                <p>Don't have the client yet? Download it <a class="text-name" href="/setup/download">here</a>.</p>
                    ...
                    <?php if ($canPlay) { ?>
                        <script defer>
                            ...
                            function play() {
                                ...
                                const launchParams = `rovive-launcher:1+launchmode:play+clientVersion:${clientVersion}+gameinfo:${token}+launchtime:${launchTime}+placelauncherurl:${launcherUrl}+browsertrackerid:false+robloxLocale:en_us+gameLocale:en_us`;

                                window.location.href = launchParams;
                            }

                            function playJobId(jobId) {
                                const launchTime = new Date().getTime();
                                const launcherUrl = `http://www.rovive.pro/Game/PlaceLauncher.ashx?placeId=${placeId}&jobId=${jobId}`;
                                const launchParams = `rovive-launcher:1+launchmode:play+clientVersion:${clientVersion}+gameinfo:${token}+launchtime:${launchTime}+placelauncherurl:${launcherUrl}+browsertrackerid:false+robloxLocale:en_us+gameLocale:en_us`;

                                window.location.href = launchParams;
                            }
                        </script>
                        <div class="VisitButton VisitButtonPlayGLI">
                            <?php if (strpos($_SERVER["HTTP_USER_AGENT"], "ROBLOX Android App") == false) { ?>
                                <a id="PlayCustomButton" class="btn-primary-lg" onclick="play()">Play</a>
                            <?php } else { ?>
                                <a id="PlayCustomButton" class="btn-primary-lg" href="/games/start?placeid=<?= $game["id"] ?>">Play</a>
                            <?php } ?>
                        </div>
                        <script>
                        ...
                        <?php } if ($isPlayServiceDown) { ?>
                            Sorry, games are temporarily disabled.
                        <?php } elseif ($isUserNotLoggedIn) { ?>
                           Please login to play this place.
                        <?php } elseif (!$canPlay) { ?>
                ...
                <ul class="share-rate-favorite">
                    ...
                    <li class="favorite-button-container">
                        <div class="tooltip-container" data-toggle="tooltip" title="" data-original-title="Add to Favorites">
                            <a id="toggle-favorite" data-toggle-url="/favorite/toggle" data-assetid="<?= $game["id"] ?>" data-isguest="False" data-signin-url="https://www.rovive.pro/newlogin">
        ...
        <div class="col-xs-12 rbx-tabs-horizontal" data-place-id="<?= $game["id"] ?>">
            ...
            <div class="tab-content rbx-tab-content">
                <div class="tab-pane active" id="about">
                        ...
                        <div class="section-content">
                            ...
                            <ul class="game-stats-container">
                                <li class="game-stat">
                                    ...
                                    <p class="text-lead"><?= intval($playerAmount) ?></p>
                                </li>
                                <li class="game-stat">
                                ...
                                <li class="game-stat">
                                    ...
                                    <p class="text-lead">
                                        <a class="text-name" href="https://www.rovive.pro/games?GenreFilter=1"><?= $game["genre"] ?></a>
                                    </p>
                                </li>
                                <li class="game-stat">
                            ...
                            <div class="game-stat-footer">
                                ...
                                <span class="game-report-abuse"><a class="text-report" href="https://www.rovive.pro/abusereport/asset?id=<?= $game["id"] ?>">Report
                                        Abuse</a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        ...
                        Roblox.PrivateServers.UserProfileAbsoluteUrlPattern =
                            "https://www.rovive.pro/users/0/profile";
                        //<sl:translate>
                    </script>
                ...
                <div class="tab-pane game-instances" id="game-instances">
                    ...
                    <script>
                        let refreshServerList = () => {
                            $("#rbx-game-server-item-container").html("<div id='rbx-running-games-loading' class='loading loading-default'>Loading...</div>");
                            $.ajax({
                                type: "GET",
                                url: "/api/getRunningGames?placeId=" + <?= $game["id"] ?>,
                                success: function(data) {
                                    $("#rbx-game-server-item-container").html(data);
                                }
                            })
                        }
                    ...
                    <div id="rbx-running-games" class="stack" data-placeid="<?= $game["id"] ?>" data-showshutdown data-avatar-headshot-enabled=true>
                        <div class="container-header">
                            ...
                            <span class="btn-fixed-width btn-control-xs btn-more rbx-running-games-refresh" onclick="refreshServerList()">Refresh</span>
                        </div>
                        <ul id="rbx-game-server-item-container" class="section rbx-game-server-item-container stack-list">
                            <div id="rbx-running-games-loading" class="loading loading-default">Loading...</div>
                        </ul>
    ...
    <div id="BCOnlyModal" class="modal-dialog" style="display: none;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="https://www.rovive.pro/premium/membership?ctx=bc-only-item" class="btn-primary-md">Upgrade Now</a>
