...
$signupEnabled = SITE_CONFIG["site"]["canSignup"];
            ...
            <div class="row">
                <div class="navbar-header col-md-6">
                    ...
                    <ul id="TopLeftNavLinks" class="nav navbar-nav">
                        ...
                        <li class="discordInv"><a href="/discord">Discord</a></li>
                        <li id="magic-line" style="left:41px;"></li>
                    </ul>
                                                ...
                                                <div class="signup-input-area" ng-form name="signupForm" rbx-form-context context="RollerCoaster">
                                                    ...
                                                    <script>
                                                        ...
                                                        $("#signup-button").on("click", function() {
                                                            ...
                                                            let birthday = $("#DayDropdown").val() + " " + $("#MonthDropdown").val() + " " + $("#YearDropdown").val();
                ...
                <div class="row" id="InnerWhatsRobloxContainer1">
                    <div id="WhatIsRobloxTextBg" class="col-sm-5 col-sm-offset-6 col-xs-8 col-xs-offset-2">
                        ...
                        <p class="lead text-justify">
                            ...
                            We currently have 2016. We will soon have 2018 and possibly 2019 or 2021.
                        </p>
                    </div>
                </div>
