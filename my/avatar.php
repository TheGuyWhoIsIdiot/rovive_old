...
$bodycolors = User::getUser($_SESSION["user"]["id"])["bodycolors"];

if ($bodycolors == "{}") {
    $bodycolors = '{"HeadColor": 1, "LeftArmColor": 1, "LeftLegColor": 1, "RightArmColor": 1, "RightLegColor": 1, "TorsoColor": 1}';
}
...
$bodycolorsparsed = [
    (int)$bodycolors["HeadColor"] == 0 ? 1 : (int)$bodycolors["HeadColor"],
    (int)$bodycolors["LeftArmColor"] == 0 ? 1 : (int)$bodycolors["LeftArmColor"],
    (int)$bodycolors["LeftLegColor"] == 0 ? 1 : (int)$bodycolors["LeftLegColor"],
    (int)$bodycolors["RightArmColor"] == 0 ? 1 : (int)$bodycolors["RightArmColor"],
    (int)$bodycolors["RightLegColor"] == 0 ? 1 : (int)$bodycolors["RightLegColor"],
    (int)$bodycolors["TorsoColor"] == 0 ? 1 : (int)$bodycolors["TorsoColor"],
];


$bodycolorsparsed = "[" . implode(',', $bodycolorsparsed) . "]";
?>
...
<style>
    .container-footer { /* hide the footer cuz idfk whats going on the avatar page since it cuts it off */
        display: none;
    }
</style>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                ...
                                <div class="col-12"><img class="image-0-2-64" id="avatar-render" src="https://www.rovive.pro/api/getAvatarImage?id=<?= $_SESSION["user"]["id"] ?>">
                                    <div class="renderButtonWrapper-0-2-57">
                                        ...
                                        <span id="savechanges-loading-container" class="hidden"><img src="/img/ec4e85b0c4396cf753a06fade0a8d8af.gif"></span>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <p class="mb-0">Something wrong with your Avatar?</p>
                                    <p class="mb-0"><a id="re-draw" href="#">Click here to re-draw it!</a><span id="redraw-loading-container" class="hidden"><img src="/img/ec4e85b0c4396cf753a06fade0a8d8af.gif"></span></p>
                                    <script defer>
                                        $("#re-draw").on("click", function() {
                                            $("#re-draw").css("display", "none");
                                            $("#redraw-loading-container").removeClass("hidden");
                                            $.ajax({
                                                url: "/api/avatar/redraw",
                                                success: function(data) {
                                                    $("#avatar-render").attr("src", "https://www.rovive.pro/api/getAvatarImage?id=<?= $_SESSION["user"]["id"] ?>");
                                                },
                                                complete: function() {
                                                    $("#redraw-loading-container").addClass("hidden");
                                                    $("#re-draw").css("display", "block");
                                                }
                                            });
                                        });
                                    </script>
                            ...
                            <div class="row-0-2-76 row">
                                ...
                                <script>
                                    ...
                                    const startColors = <?= $bodycolorsparsed ?>;
                                    ...
                                    saveBtn.addEventListener('click', () => {
                                        $(".renderButton-0-2-58").addClass("hidden");
                                        $("#savechanges-loading-container").removeClass("hidden");
                                        ...
                                        const data = {
                                            "HeadColor": lastHeadColor,
                                            "LeftArmColor": lastLeftArmColor,
                                            "LeftLegColor": lastLeftLegColor,
                                            "RightArmColor": lastRightArmColor,
                                            "RightLegColor": lastRightLegColor,
                                            "TorsoColor": lastTorsoColor
                                        };
                                        ...
                                        $.ajax({
                                            ...
                                            complete: function() {
                                                $(".renderButton-0-2-58").removeClass("hidden");
                                                $("#savechanges-loading-container").addClass("hidden");
                                            }
                                        });
                                    });
                                </script>
