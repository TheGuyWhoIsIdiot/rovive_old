...
switch($genre){
	case "GameStuff":
		$ToolboxFetch = $pdo->prepare("SELECT * FROM templates WHERE approved = '1' AND public = '1' AND free = '1' AND genre = 'GameStuff' AND itemtype = 'model'");
		$ToolboxFetch->execute();
		break;
	case "Weapons":
		$ToolboxFetch = $pdo->prepare("SELECT * FROM templates WHERE approved = '1' AND public = '1' AND free = '1' AND genre = 'Weapons' AND itemtype = 'model'");
		$ToolboxFetch->execute();
		break;
	default:
		$ToolboxFetch = $pdo->prepare("SELECT * FROM templates WHERE approved = '1' AND public = '1' AND free = '1' AND itemtype = 'model'");
		$ToolboxFetch->execute();
		break;
}
